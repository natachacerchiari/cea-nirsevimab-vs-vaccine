...
calculate_icer_components <- function(ne_malrti, ne_hospitalization, nirsevimab_coverage, inpatient_rate_0_3m, 
                                ...
                                outpatient_rate_3_6m, outpatient_rate_6_12m,
                                inpatient_cost_0_3m, inpatient_cost_3_6m, inpatient_cost_6_12m,
                                outpatient_cost, outpatient_cost_ec, daly_moderate, daly_severe) {
...
meu_grafico <- ggplot(resultados, aes(x = x, y = y)) +
  ...
  annotate("text", 
           x = max(resultados$x) * 0.99,  # 80% do eixo x
